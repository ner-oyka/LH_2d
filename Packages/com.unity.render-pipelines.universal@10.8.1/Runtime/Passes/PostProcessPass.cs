...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class PostProcessPass : ScriptableRenderPass
    {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            m_EdgesBlur           = stack.GetComponent<EdgesBlur>();
        ...
        void Render(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, ProfilingSampler.Get(URPProfileId.UberPostProcess)))
            {
                ...
                SetupEdgesBlur(m_Materials.uber);
        ...
        void SetupEdgesBlur(Material material)
        {
            var power = m_EdgesBlur.power.value;
            var darkness = m_EdgesBlur.darkness.value;
            var distance = m_EdgesBlur.distance.value;
            var hardness = m_EdgesBlur.hardness.value;

            var v1 = new Vector4(
                power, darkness, distance,
                hardness
            );

            material.SetVector(ShaderConstants._EdgesBlur_Params1, v1);
        }
        ...
        static class ShaderConstants
        {
            ...
            public static readonly int _EdgesBlur_Params1   = Shader.PropertyToID("_EdgesBlur_Params1");
